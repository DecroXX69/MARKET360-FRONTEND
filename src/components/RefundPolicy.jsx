    ...
    <div className="card shadow-sm mb-4">
      <div className="card-body">
        ...
        <ol className="ps-3 mb-4">
          <li className="mb-2"><strong>Eligibility for Refunds:</strong> Refunds are only available for products that are returned in their original condition within [number of days] days of purchase.</li>
          ...
          <li className="mb-2"><strong>Refund Timeframe:</strong> Once your return is received and inspected, we will send you an email to notify you that we have received your returned item and the approval or rejection of your refund. Once approved, refunds will take [number of days] to be credited into the beneficiary’s bank account.</li>
          <li className="mb-2"><strong>Exchanges:</strong> We only replace items if they are defective or damaged. In case of exchanges, we will initiate the process within [number of days] and the replacement will be delivered within [number of days].</li>
        </ol>
        ...
        <ol className="ps-3 mb-4">
          ...
          <li className="mb-2"><strong>Return Process:</strong> To initiate a return, please contact our customer support team within [number of days] days of receiving your item.</li>
          ...
          <li className="mb-2"><strong>Return Timeframe:</strong> In case of an approved return, your replacement will be delivered within [number of days].</li>
        </ol>
        ...
        <ol className="ps-3 mb-4">
          ...
          <li className="mb-2"><strong>Shipping Times:</strong> Orders are typically processed, shipped and delivered within [number of days] business days.</li>
          <li className="mb-2"><strong>International Shipping:</strong> We offer international shipping to select countries. Please note that customs duties and taxes may apply. Orders will be delivered within [number of days] business days.</li>
